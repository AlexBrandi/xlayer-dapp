  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[9999] p-4">
      <div className="glass-card p-6 max-w-md w-full">
        ...
        <div className="mb-6">
          <div className="glass-card p-4 bg-gray-800/50 text-center mb-4">
            <h3 className="text-lg font-bold text-white mb-2">
              战舰 #{tokenId.toString()}
            </h3>
            <p className="text-gray-400">
              当前等级: <span className="text-cyan-400 font-bold">{currentLevel}</span> → 
              <span className="text-green-400 font-bold"> {currentLevel + 1}</span>
            </p>
          </div>

          <div className="space-y-3">
            <h4 className="text-sm text-gray-400 font-semibold">升级成本：</h4>
            
            {tokenCost > 0n && (
              <div className="flex justify-between items-center glass-card p-3 bg-gray-800/30">
                <span className="text-sm text-gray-300">FUEL</span>
                <div className="text-right">
                  <p className="text-white font-bold">{formatEther(tokenCost)}</p>
            ...
            {gem1Cost > 0n && (
              <div className="flex justify-between items-center glass-card p-3 bg-gray-800/30">
                <span className="text-sm text-blue-400">蓝宝石</span>
                <div className="text-right">
                  <p className="text-white font-bold">{gem1Cost.toString()}</p>
            ...
            {gem2Cost > 0n && (
              <div className="flex justify-between items-center glass-card p-3 bg-gray-800/30">
                <span className="text-sm text-orange-400">太阳石</span>
                <div className="text-right">
                  <p className="text-white font-bold">{gem2Cost.toString()}</p>
            ...
            {gem3Cost > 0n && (
              <div className="flex justify-between items-center glass-card p-3 bg-gray-800/30">
                <span className="text-sm text-purple-400">锂矿石</span>
                <div className="text-right">
                  <p className="text-white font-bold">{gem3Cost.toString()}</p>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 btn-primary bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 disabled:from-gray-600 disabled:to-gray-700"
          >
            {isUpgrading ? (
